...
object WordExtra {
  def main(args: Array[String]) {
    ...
    // 获取参数
    val frequencyThreshold : Int = 1 // 词频阈值
    val consolidateThresholdLow : Double = 100.0  // 凝结度下界
    val consolidateThresholdHigh : Double = 1000000.0  // 凝结度阈值上限
    val freedomThreshold : Double = 0.02  // 最小自由熵阈值
    val wordLength : Int= 6  // 最长词长度
    val numPartiton : Int = 4 // partition数，并行度
